...
import { Plus, Search, Filter, MoreHorizontal, Play, Pause, Settings, Copy, Trash2, BarChart3 } from 'lucide-react';
...
export default function WidgetsPage() {
  ...
  const [typeFilter, setTypeFilter] = useState<'all' | 'agent' | 'tool' | 'workflow'>('all');
  ...
  const handleCopyEmbedCode = async (widget: Widget) => {
    ...
    try {
      const embedData = await generateEmbedCode(widget.id, { format: 'javascript' });
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Error Loading Widgets</h2>
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Create and manage embeddable widgets from your agents, tools, and workflows
              </p>
            </div>
            <Button onClick={() => router.push('/widgets/create')} className="flex items-center gap-2">
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <Button onClick={() => router.push('/widgets/create')}>Create Widget</Button>
          </div>
        ) : (
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => router.push(`/widgets/${widget.id}/edit`)}>
                        ...
                        <DropdownMenuItem onClick={() => router.push(`/widgets/${widget.id}/analytics`)}>
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="text-sm text-gray-600">
                      <div>Usage: {widget.usageCount} executions</div>
