...
export function AIAssistedConfiguration() {
    ...
    const { generateAgentConfig, isGenerating, previewAgentResponse } = useAIAssistant();
    ...
    }, [agentPrompt, selectedModel, temperature, personalityTraits, previewAgentResponse]);
